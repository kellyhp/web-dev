      ...
      {people.map((person) => (
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
                <div className="absolute inset-x-10 z-30 w-[20%] -bottom-pxh-px " />
                <div className="absolute left-10 w-[40%] z-30 -bottom-px h-px " />
                <div className="font-bold text-white relative z-30 text-base">
                  {person.name}
                </div>
                <div className="text-white text-xs">{person.designation}</div>
              </motion.div>
            )}
          </AnimatePresence>
          <Image
            ...
            height= {100}
            width={100}
            src={require("../../../public/assets/logo/" + person.image)}
            alt={person.name}
