...
export default function Home() {
  ...
  useEffect(() => {
    // After 2 seconds, set showContent to true to trigger animation
  ...
  const links = [
    ...
    { text: 'My Experience', href: '/Experience' }, // Add your href here
    { text: 'Projects', href: '/Projects' }, // Add your href here
    { text: 'UI/UX Case Studies', href: '/CaseStudy' }, // Add your href here
  ...
  return (
    <div className="flex flex-col justify-center h-screen">
        ...
        <div className="md:flex md:justify-between md:items-center md:h-full gap-16 py-10">
          <div className="basis-2/3 mt-12 md:mt-32 md:order-1 mx-auto">
            {/* HEADINGS */}
            <animated.div style={contentAnimation}>
              <div className="flex items-center justify-center">
              <button className="button w-[300px] h-[350px] md:my-10 my-0 mb-10 mt-60 mx-auto md:mt-0 relative overflow-hidden">
                <Image
                  alt="profile"
          ...
          {/* LINK SECTION */}
          <div className="md:order-2 flex justify-center md:basis-4/5 z-10 mt-0 md:mt-32 py-10 md:items-start items-center">
            <div className="md:min-w-[700px] flex flex-col font-dmserifdisplay ml-5">
